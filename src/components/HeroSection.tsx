  ...
  return (
    ...
    >
      <div className="relative w-full h-[60vh] md:h-[85vh] overflow-hidden">
        ...
        {/* LABEL DESKTOP — canto superior direito */}
        <div
          className="hidden md:block absolute top-8 right-8 text-white font-rolide tracking-widest"
          style={{ fontSize: "32px", lineHeight: 1, fontVariantNumeric: "tabular-nums" }}
        >
          {images[current].label}
        </div>

        {/* LABEL MOBILE — canto superior direito */}
        <div
          className="md:hidden absolute top-4 right-4 text-white font-rolide tracking-widest text-base"
